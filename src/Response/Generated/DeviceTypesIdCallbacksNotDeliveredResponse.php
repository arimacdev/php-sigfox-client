...
/**
 * @implements PaginatedResponse<ErrorMessages>
 */
class DeviceTypesIdCallbacksNotDeliveredResponse extends Model implements PaginatedResponse
{
    ...
    {
        $serializers = array('data' => new ArraySerializer(new ClassSerializer(ErrorMessages::class)), 'paging' => new ClassSerializer(Paging::class));
        return $serializers;
    }
    /**
     * @inheritdoc
