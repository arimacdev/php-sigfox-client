...
/**
 * @implements PaginatedResponse<DeviceLocation_2>
 */
class DevicesIdLocationsResponse extends Model implements PaginatedResponse
{
    /**
    ...
    {
        $serializers = array('data' => new ArraySerializer(new ClassSerializer(DeviceLocation_2::class)), 'paging' => new ClassSerializer(Paging::class));
        return $serializers;
    }
    /**
     * @inheritdoc
