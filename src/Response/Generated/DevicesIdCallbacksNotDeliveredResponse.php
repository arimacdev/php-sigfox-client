...
class DevicesIdCallbacksNotDeliveredResponse extends Definition
{
    ...
    {
        return array('data' => new ArraySerializer(self::class, 'data', new ClassSerializer(self::class, 'data', DeviceErrorMessages::class)), 'paging' => new ClassSerializer(self::class, 'paging', Paging::class));
    }
}