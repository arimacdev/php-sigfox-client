...
class ContractInfo extends CommonContractInfo
{
     ...
     * @return static To use in method chains
     */
    public function setOrder(?MinContractInfo $order)
    {
        $this->order = $order;
        return $this;
    }
     ...
     * @return static To use in method chains
     */
    public function setTokensInUse(?int $tokensInUse)
    {
     ...
     * @return static To use in method chains
     */
    public function setTokensUsed(?int $tokensUsed)
    {
    ...
    {
        $rules = array('group' => array(new Child()), 'order' => array(new Child()), 'blacklistedTerritories' => array(new ChildSet()));
