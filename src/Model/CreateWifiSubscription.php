 ...
 */
class CreateWifiSubscription extends CreateInternetSubscription
{
    /**
     * COMPANY
     */
     ...
     * 
     * - {@see CreateWifiSubscription::NETWORK_TYPE_COMPANY}
     * - {@see CreateWifiSubscription::NETWORK_TYPE_OTHER}
     * - {@see CreateWifiSubscription::NETWORK_TYPE_RESIDENT}
     *
     * @var int
     */
     ...
     * 
     * - {@see CreateWifiSubscription::ETH_CONNECTION_TYPE_DHCP}
     * - {@see CreateWifiSubscription::ETH_CONNECTION_TYPE_STATIC}
     *
     * @var int
     */
