 ...
 */
class CreateGsmSubscription extends CreateInternetSubscription
{
    /**
     * DONGLE_USB
     */
     ...
     * 
     * - {@see CreateGsmSubscription::GSM_CONNECTION_TYPE_DONGLE_USB}
     * - {@see CreateGsmSubscription::GSM_CONNECTION_TYPE_ROUTER_ETH}
     *
     * @var int
     */
    ...
    {
        $rules = array('modemSerialNumber' => array(new Required()));
