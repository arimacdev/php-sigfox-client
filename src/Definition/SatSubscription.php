...
class SatSubscription extends InternetSubscription
{
     ...
     * - `SatSubscription::CONNECTION_STATUS_REQUEST`
     * - `SatSubscription::CONNECTION_STATUS_CREDENTIALS_PROVIDED`
     * - `SatSubscription::CONNECTION_STATUS_KIT_RECEIVED`
     *
     * @var int
     */
     ...
     * - `SatSubscription::R_TYPE_HEATING`
     * - `SatSubscription::R_TYPE_STANDARD`
     *
     * @var int
     */
