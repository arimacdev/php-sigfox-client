...
class DevicesBulkUnsubscribeJobId
{
    ...
    {
        return $this->client->call('get', Helper::bindUrlParams('/devices/bulk/unsubscribe/{jobId}', $this->jobId), null, ActionJob::class, array(400 => BadRequestException::class, 401 => UnauthorizedException::class, 403 => ForbiddenException::class, 404 => NotFoundException::class, 500 => InternalServerException::class));
    }
}