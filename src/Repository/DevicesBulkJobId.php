...
class DevicesBulkJobId
{
    ...
    {
        return $this->client->call('get', Helper::bindUrlParams('/devices/bulk/{jobId}', $this->jobId), null, RegistrationJobStatus::class, array(400 => BadRequestException::class, 401 => UnauthorizedException::class, 403 => ForbiddenException::class, 404 => NotFoundException::class, 500 => InternalServerException::class));
    }
}