...
use Arimac\Sigfox\Request\OperatorsIdGet;
use Arimac\Sigfox\Model\OperatorRead;
...
use Arimac\Sigfox\Request\OperatorsIdUpdate;
class OperatorsId
{
    /**
     * The HTTP client
    ...
    /**
     * The Operator id (hexademical format)
     *
     * @internal
     */
    protected ?string $id;
